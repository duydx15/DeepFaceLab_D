...
if __name__ == "__main__":
    ...
    path = "/home/ubuntu/Duy_test_folder/Retinaface_Mediapipe/Avatar_enhance/Cowboy_Doc_open2.png"
    ...
    data = extract_face_retina(image_tmp,face_mesh_wide,trackkpVideoMount,trackkpVideoFace)
    # print(data)
    ...
    merge_face_img = MergeMasked(predictor_func,
                                 ...
                                 config_merge_mask_cop,data,image_tmp,image_tmp,remerge=False,skip_merge=False)
    #     cv2.imwrite("Final_merge.png",merge_face_img[...,0:3])
    image_ori[:,:,:3] = merge_face_img[...,0:3]
    cv2.imwrite("/home/ubuntu/Duy_test_folder/Retinaface_Mediapipe/Avatar_enhance/Cowboy_Doc_open2_DFL.png",image_ori)
    # break
