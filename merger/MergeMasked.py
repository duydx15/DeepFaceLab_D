...
def MergeMaskedFace (predictor_func, predictor_input_shape,
    ...
    # print(img_face_landmarks,type(img_face_landmarks))
    # print(img_bgr.shape,type(img_bgr),np.max(img_bgr))
    # print(img_bgr_uint8.shape,type(img_bgr_uint8),np.max(img_bgr_uint8))
    # cv2.imwrite("input.png",img_face_landmarks)
