...
if __name__ == '__main__':
	...
	dim = (256, 256)
	list_img_source = ['/home/ubuntu/first-order-model/data/04.png', '/home/ubuntu/first-order-model/data/08.jpg',
						'/home/ubuntu/first-order-model/data/09.jpg']
	source_image = []
	for value in list_img_source:
		im = Image.open(value)
		im = im.resize(dim)
	...
	# source_image = [source_image[4],source_image[1],source_image[8]]
	source_image_euler_angles = [(0, 0, 0), (75, 0, 0), (-75, 0, 0)]
	...
	with open ('face.csv','a') as allpckts:
		# fieldnames = ['Datetime', 'brandmodel', 'AveragePrice1', 'AveragePrice3', 'plate']
		...
		while cap.isOpened():
			...
			if not detected_face:
				# writer.writerow({'Frame': format(frame_count, '05d'), 'yaw': 0, 'pitch': 0, 'roll': 0})
				...
				# writer.writerow({'Frame': format(frame_count, '05d'), 'yaw': yaw, 'pitch':pitch, 'roll': roll})
