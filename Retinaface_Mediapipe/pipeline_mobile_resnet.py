...
def detection_face(mobile_net,resnet_net, img, device,padding_ratio):
	H,W,_ = img.shape
	...
	return  detected_face,truth_face_coordinate
...
def loadmodelface():
	path_pretrain = str(Path(__file__)).split('pipeline_mobile_resnet')[0]
	...
	mobile_net = load_model(mobile_net, path_pretrain+"weights/mobilenet0.25_Final.pth", args.cpu)
	mobile_net.eval()
	...
	resnet_net = load_model(resnet_net, path_pretrain+"weights/Resnet50_Final.pth", args.cpu)
	resnet_net.eval()
