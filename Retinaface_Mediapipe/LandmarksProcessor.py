...
def get_transform_mat (image_landmarks, output_size, face_type, scale=1.0):
    ...
    # face_landmarks = np.array(face_landmarks/output_size)
    # face_landmarks = np.concatenate ( [ face_landmarks[17:49] , face_landmarks[54:55] ] )
    # print(face_landmarks.shape)
    # print(landmarks_2D_new.shape)


    # estimate landmarks transform from global space to local aligned space with bounds [0..1]
    mat = umeyama( image_landmarks , landmarks_2D, True)[0:2]
